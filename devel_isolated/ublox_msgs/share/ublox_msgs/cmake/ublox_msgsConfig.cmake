...
if("TRUE" STREQUAL "TRUE")
  set(ublox_msgs_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ublox/ublox_msgs)
  set(ublox_msgs_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel_isolated/ublox_msgs)
  ...
  set(ublox_msgs_INSTALL_PREFIX /home/ubuntu/catkin_ws/install_isolated)
...
if(NOT "/home/ubuntu/catkin_ws/devel_isolated/ublox_msgs/include;/home/ubuntu/catkin_ws/src/ublox/ublox_msgs/include " STREQUAL " ")
  set(ublox_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/devel_isolated/ublox_msgs/include;/home/ubuntu/catkin_ws/src/ublox/ublox_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ublox_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Johannes Meyer <nothing@nobody.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ublox_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ublox/ublox_msgs/${idir}'.  Ask the maintainer 'Johannes Meyer <nothing@nobody.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/catkin_ws/devel_isolated/ublox_msgs/lib;/home/ubuntu/catkin_ws/install_isolated/lib;/home/ubuntu/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
