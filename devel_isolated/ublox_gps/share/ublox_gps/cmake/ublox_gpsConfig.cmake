...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ublox/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel_isolated/ublox_gps)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/ubuntu/catkin_ws/install_isolated)
...
if(NOT "/home/ubuntu/catkin_ws/src/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/ublox/ublox_gps/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Gareth Cross <gcross.code@icloud.com>, Chao Qu <quchao@seas.upenn.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ublox/ublox_gps/${idir}'.  Ask the maintainer 'Gareth Cross <gcross.code@icloud.com>, Chao Qu <quchao@seas.upenn.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/catkin_ws/devel_isolated/ublox_gps/lib;/home/ubuntu/catkin_ws/install_isolated/lib;/home/ubuntu/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
