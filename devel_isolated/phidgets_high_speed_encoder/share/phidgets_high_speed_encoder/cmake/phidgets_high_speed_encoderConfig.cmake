...
if(NOT "/home/ubuntu/catkin_ws/devel_isolated/phidgets_high_speed_encoder/include " STREQUAL " ")
  set(phidgets_high_speed_encoder_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/devel_isolated/phidgets_high_speed_encoder/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_high_speed_encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/phidgets_drivers/phidgets_high_speed_encoder/${idir}'.  Ask the maintainer 'Geoff Viola <geoffrey.viola@asirobots.com>, José-Luis Blanco Claraco <jlblanco@ual.es>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/catkin_ws/devel_isolated/phidgets_high_speed_encoder/lib;/home/ubuntu/catkin_ws/install_isolated/lib;/home/ubuntu/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
